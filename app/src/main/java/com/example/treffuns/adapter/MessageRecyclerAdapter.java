...
import com.example.treffuns.model.ChatMessageModel;
import com.example.treffuns.utils.FirebaseUtil;
import com.firebase.ui.firestore.FirestoreRecyclerAdapter;
import com.firebase.ui.firestore.FirestoreRecyclerOptions;

public class MessageRecyclerAdapter extends FirestoreRecyclerAdapter<ChatMessageModel, MessageRecyclerAdapter.ChatMessageModelViewHolder> {
     ...
     * @param options
     */
    public MessageRecyclerAdapter(@NonNull FirestoreRecyclerOptions<ChatMessageModel> options, Context context) {
        super(options);
